...
category: Quick Tips
img: ./rename-variables-object-destructure.jpg
slug: 'destructured-properties-plus-renaming'
tags:
- ES6
---
...
<h3 className="my-4 text-3xl font-bold leading-tight text-gray-900 md:text-4xl">Assigning destructed variables to new variable names</h3>
...
<h3 className="my-4 text-3xl font-bold leading-tight text-gray-900 md:text-4xl">My real world use case for renaming destructed object properties</h3>
