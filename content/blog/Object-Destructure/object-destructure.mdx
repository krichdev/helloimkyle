...
<h3 className="my-4 text-3xl font-bold leading-tight text-gray-900">Assigning destructed variables to new variable names</h3>
...
<h3 className="my-4 text-3xl font-bold leading-tight text-gray-900">My real world use case for renaming destructed object properties</h3>
